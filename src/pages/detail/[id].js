  ...
  return (
    <div className="mt-16 md:mt-16">
      ...
      <div 
        ...
        style={{
          backgroundImage: `url("/uploads/museum/museum-bank-indonesia-tampak-dalam.jpg")`
        }}
      >
        <div className="flex flex-col justify-center items-center bg-black/70 md:bg-black/60 w-full md:w-[70vw] h-full p-6 md:p-0">
          <div className="flex flex-col justify-center text-[#FFFBD9] w-full md:w-[70%] h-auto md:h-1/2 text-center md:text-left py-5 md:py-0 animate-pulse">
            <p className="font-bold text-[32px] md:text-[48px] leading-[1.2] md:leading-[1.1] mb-4 md:mb-3 drop-shadow-[2px_2px_4px_rgba(0,0,0,0.8)]">
              {/* {museum.nama || "Museum"} */} NAMA MUSEUM
            </p>
            <p className="text-base md:text-xl leading-6 mb-5 md:mb-4 drop-shadow-[1px_1px_2px_rgba(0,0,0,0.8)]">
              {/* {museum.deskripsi || "Deskripsi museum akan muncul di sini."} */} DESKRIPSI MUSEUM
            </p>
            <a 
              href="#daftar-koleksi" 
